...
// - a <link> to /styles/just-the-docs-head-nav.css,
...
function initSearch() {
  ...
  request.open('GET', '{{ "stylessearch-data.json" | relative_url }}', true);
...
jtd.setTheme = function(theme) {
  ...
  cssFile.setAttribute('href', '{{ "styles/just-the-docs-" | relative_url }}' + theme + '.css');
}
